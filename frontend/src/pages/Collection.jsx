        ...
        <div className='min-w-60'>
            ...
            <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
              {categories.map((cat) => (
                <p key={cat._id} className='flex gap-2'>
                  <input type="checkbox" className='w-3' value={cat.name} onChange={toggleCategory}/> {cat.name}
                </p>
              ))}
            </div>
          </div>
          <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
            ...
            <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
              ...
              <p className='flex gap-2'>
                <input type="checkbox" className='w-3' value={'Ethnic Wear'} onChange={toggleSubCategory}/> Ethnic Wear
              </p>
            </div>
          </div>
      </div>
