        ...
        <div className='bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-10'>
          ...
          <div className='text-center mb-8'>
            ...
            <p className='text-gray-600 mt-4'>
              {currentState === 'Login' 
                ...
                : 'Create your account to get started with Click&Cart.'
              }
            </p>
          </div>
          ...
          <form onSubmit={onSubmitHandler} className='space-y-6'>
            ...
            <div className='flex justify-between items-center text-sm'>
              <button 
                type='button'
                className='text-yellow-600 hover:text-yellow-700 font-medium transition-colors duration-200 cursor-pointer'
              >
                Forgot Password?
              </button>
              <button 
                ...
                className='text-gray-600 hover:text-yellow-600 font-medium transition-colors duration-200 cursor-pointer'
              >
          ...
          <div className='mt-8'>
            ...
            <div className='mt-6'>
              <button 
                type='button'
                className='w-full flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-200 group'
              >
                ...
                <span className='ml-2 text-gray-700 group-hover:text-gray-900 font-medium'>Google</span>
              </button>
            </div>
          </div>
        </div>
