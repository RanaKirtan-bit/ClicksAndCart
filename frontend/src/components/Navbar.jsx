...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 px-2 font-medium bg-linear-to-r from-white to-yellow-100 shadow-sm transition-all duration-300'>
      ...
      <ul className='hidden sm:flex gap-8 text-medium text-black-700'>
            <NavLink to='/' className='group flex flex-col items-center gap-1 relative overflow-hidden'>
                  ...
                  <hr className='w-0 group-hover:w-full border-none h-0.5 bg-linear-to-r from-yellow-600 to-yellow-500 transition-all duration-500 ease-out' />
            </NavLink>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='relative' onMouseEnter={() => setIsProfileOpen(true)} onMouseLeave={() => setIsProfileOpen(false)}>
          ...
          {token && (
          <div className={`absolute dropdown-menu right-0 sm:right-0 sm:left-auto left-30 top-full pt-2 transition-all duration-300 transform z-50 ${
